    ...
    <svg className="circuit-svg" viewBox="0 0 800 460" fill="none">
      ...
      {nodes.map(n=>(
        <g key={n.id} filter="url(#gn)">
          ...
          <text x={n.x} y={n.y-(n.main?10:6)} textAnchor="middle" fontSize={n.main?22:15}>{n.emoji}</text>
          <text x={n.x} y={n.y+(n.main?18:14)} textAnchor="middle" fill={n.color} fontSize={n.main?11:9} fontWeight="700">{n.label}</text>
        </g>
      ))}
    </svg>
  )
      ...
      <div className={`main-wrapper ${showSplash ? 'main-hidden' : 'main-visible'}`}>
        ...
        <section className="hero" id="home">
          ...
          <div className="hero-content">
            ...
            <div className="hero-tags">
              <span className="hero-tag">AI/ML Engineer</span>
              <span className="hero-tag">Python Developer</span>
              <span className="hero-tag">CSE Student</span>
            </div>
        ...
        <div className="skills-section" id="skills">
          <div className="skills-inner">
            <Reveal><p className="section-label">My Skills</p></Reveal>
            <Reveal delay={80}><h2 className="section-heading">My Skills</h2></Reveal>
